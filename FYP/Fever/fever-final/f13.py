...
# CONFIG
# Files 
ANSWER_CACHE_FILE = "fever_answers_cache.csv"

OUT_JSON_FILE = "fever_paper_overall_summary.json"
OUT_CSV_FILE  = "fever_paper_overall_summary.csv"

ERROR_CASES_FILE = "fever_paper_error_cases.csv"
MAX_ERROR_LOGS_PER_MODE = 200

MITI_CASES_FILE = "fever_mitigation_cases.csv"
MAX_CASES_PER_RUN = 500

THRESHOLD_ANALYSIS_FILE = "fever_threshold_analysis.csv"
...
def score_single_answer_full(question, evidence, gold_label, answer_text, sc_override=None):
    ...
    ent, con = detector_mnli_signal(evidence, label_text)
...
print(
    ...
    f"{'filtered_halluc':>10s} {'valid_ans':>10s} | "
...
for p in ["base", "always_mild", "always_strict_K", "policy"]:
    ...
    print(
        ...
        f"{safe_mean(filtered_halluc_rates):10.4f} | "
        ...
        f"hall_p: {safe_mean(halluc_prob_before):.3f}->{safe_mean(halluc_prob_after):.3f} | "
        f"corr_p: {safe_mean(correct_prob_before):.3f}->{safe_mean(correct_prob_after):.3f}"
    )
