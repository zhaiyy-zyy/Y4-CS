...
# ---------- Files ----------
ANSWER_CACHE_FILE = "f_answers_cache11.csv"

OUT_JSON_FILE = "f_paper_overall_summary11.json"
OUT_CSV_FILE  = "f_paper_overall_summary11.csv"

ERROR_CASES_FILE = "f_paper_error_cases11.csv"
MAX_ERROR_LOGS_PER_MODE = 200

MITI_CASES_FILE = "f_mitigation_cases11.csv"
...
def eval_mitigation_on_packs(
    ...
    for pack in packs:
        ...
        # --- NEW: only count non-NEI answers ---
        if not abstain:
            valid_answer_cnt += 1
            if final_gold_ok:
                valid_gold_ok_cnt += 1
