...
# ---------- Files ----------
ANSWER_CACHE_FILE = "nq_answers_cache_final_all21.csv"

OUT_JSON_FILE = "nq_paper_overall_summary_final_all21.json"
OUT_CSV_FILE = "nq_paper_overall_summary_final_all21.csv"

ERROR_CASES_FILE = "nq_paper_error_cases_final_all21.csv"
MAX_ERROR_LOGS_PER_MODE = 200

MITI_CASES_FILE = "nq_mitigation_cases_final_all21.csv"
...
def is_abstain_answer(ans: str):
    ...
    return any(p in x for p in abstain_patterns)
...
def generate_base_extractive_answer(question, context):
    try:
        ...
        return fallback_span_from_context(context, question)
...
def detector_conditioned_correct(
    ...
    if base_ok < 0.15:
        ...
        if abstain_if_still_risky and base_ok < abstain_threshold:
...
def eval_mitigation_on_packs(
    ...
    for pack in packs:
        ...
        base_abstain = is_abstain_answer(base_answer)
        ...
        if policy_name == "base":
            ...
            action = f"extract_K{K}_abstain" if final_answer.strip() == "" else f"extract_K{K}_group_sc"
        ...
        abstain = is_abstain_answer(final_answer)
