...
# ---------- Files ----------
ANSWER_CACHE_FILE = "nq_answers_cache_final_all27.csv"

OUT_JSON_FILE = "nq_paper_overall_summary_final_all27.json"
OUT_CSV_FILE = "nq_paper_overall_summary_final_all27.csv"

ERROR_CASES_FILE = "nq_paper_error_cases_final_all27.csv"
MAX_ERROR_LOGS_PER_MODE = 200

MITI_CASES_FILE = "nq_mitigation_cases_final_all27.csv"
...
def eval_mitigation_on_packs(
    ...
    for pack in packs:
        ...
        peer_answers = pack["answers"]  # 用整个采样集
