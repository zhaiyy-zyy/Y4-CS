...
# ---------- Files ----------
ANSWER_CACHE_FILE = "truthfulqa_answers_cache_all13.csv"

OUT_JSON_FILE = "truthfulqa_paper_overall_summary_all13.json"
OUT_CSV_FILE  = "truthfulqa_paper_overall_summary_all13.csv"

ERROR_CASES_FILE = "truthfulqa_paper_error_cases_all13.csv"
MAX_ERROR_LOGS_PER_MODE = 200

MITI_CASES_FILE = "truthfulqa_mitigation_cases_all13.csv"
...
def detector_conditioned_correct(
    ...
    if abstain_if_still_risky and (best_ok < abstain_threshold):
        ...
        if best_ok < 0.35:
            return "FINAL_ANSWER: I do not know.", best_ok, "force_abstain", base_ok
