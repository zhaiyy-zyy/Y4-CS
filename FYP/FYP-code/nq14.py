...
# ---------- Files ----------
ANSWER_CACHE_FILE = "nq_answers_cache_final_all14.csv"

OUT_JSON_FILE = "nq_paper_overall_summary_final_all14.json"
OUT_CSV_FILE = "nq_paper_overall_summary_final_all14.csv"

ERROR_CASES_FILE = "nq_paper_error_cases_final_all14.csv"
MAX_ERROR_LOGS_PER_MODE = 200

MITI_CASES_FILE = "nq_mitigation_cases_final_all14.csv"
...
def ensure_answers(question: str, context: str, n_samples: int):
    ...
    while len(cur) < n_samples and tries < max_tries:
        ...
        if (not is_bad_answer(ans)) and is_span_in_context(ans, context):
            cur.append(ans)
