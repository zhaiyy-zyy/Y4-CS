...
# ---------- Files ----------
ANSWER_CACHE_FILE = "truthfulqa_answers_cache_all2.csv"

OUT_JSON_FILE = "truthfulqa_paper_overall_summary_all2.json"
OUT_CSV_FILE  = "truthfulqa_paper_overall_summary_all2.csv"

ERROR_CASES_FILE = "truthfulqa_paper_error_cases_all2.csv"
MAX_ERROR_LOGS_PER_MODE = 200

MITI_CASES_FILE = "truthfulqa_mitigation_cases_all2.csv"
...
def score_single_answer_full(question, correct, incorrect, answer_text, sc_override=None):
    ...
    judge_ok = judge_truth(question, ans)
...
- Prefer copying the wording of the reference truths when possible.
...
def build_question_pack(q_idx):
    ...
    for ans in answers:
        ...
        judge_ok = judge_truth(q, ans_eval)
