...
# ---------- Files ----------
ANSWER_CACHE_FILE = "nq_answers_cache_final_all12.csv"

OUT_JSON_FILE = "nq_paper_overall_summary_final_all12.json"
OUT_CSV_FILE = "nq_paper_overall_summary_final_all12.csv"

ERROR_CASES_FILE = "nq_paper_error_cases_final_all12.csv"
MAX_ERROR_LOGS_PER_MODE = 200

MITI_CASES_FILE = "nq_mitigation_cases_final_all12.csv"
...
def nq_gold_ok(answer, reference):
    ...
    refs = [reference]
    if " or " in reference:
        refs = [x.strip() for x in reference.split(" or ") if x.strip()]
