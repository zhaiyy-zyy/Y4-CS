...
ANSWER_CACHE_FILE = "fever_full_model_exp_answer_cache2.csv"
...
# ============================================================
# One Monte-Carlo run (adjusted for stability comparison)
# ============================================================
...
if __name__ == "__main__":
    ...
    for m in modes:
        ...
        print("\nSaved: fever_overall_summary2.json, fever_overall_summary2.csv")