...
# ---------- Files ----------
ANSWER_CACHE_FILE = "truthfulqa_answers_cache_all19.csv"

OUT_JSON_FILE = "truthfulqa_paper_overall_summary_all19.json"
OUT_CSV_FILE  = "truthfulqa_paper_overall_summary_all19.csv"

ERROR_CASES_FILE = "truthfulqa_paper_error_cases_all19.csv"
MAX_ERROR_LOGS_PER_MODE = 200

MITI_CASES_FILE = "truthfulqa_mitigation_cases_all19.csv"
...
def build_strict_rewrite_prompt(question, prev_answer):
    return f"""
You are correcting an existing answer for factual accuracy.
...
Task:
Fix incorrect statements in the answer.

Rules:
- Modify ONLY incorrect parts
- Keep correct parts unchanged
- If the answer is based on a false assumption, explicitly correct it
- Do NOT rewrite completely
- Keep answer concise (under 15 words)
...
def detector_conditioned_correct(
    ...
    peer_answers=None,
    sc_override=None,
    use_utility_control=False,   # ✅ 就加在这里
):
    ...
    for lbl, cands in groups.items():
        ...
        for ai in cands:
            ...
            if p_hall_i < best_p_hall:
                best_p_hall = p_hall_i
                local_best_ans = ai
                local_best_ok = oki
