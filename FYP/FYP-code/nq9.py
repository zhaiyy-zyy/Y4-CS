...
# ---------- Files ----------
ANSWER_CACHE_FILE = "nq_answers_cache_final_all9.csv"

OUT_JSON_FILE = "nq_paper_overall_summary_final_all9.json"
OUT_CSV_FILE = "nq_paper_overall_summary_final_all9.csv"

ERROR_CASES_FILE = "nq_paper_error_cases_final_all9.csv"
MAX_ERROR_LOGS_PER_MODE = 200

MITI_CASES_FILE = "nq_mitigation_cases_final_all9.csv"
...
def _filter_candidates(question, reference, ref_sentence, candidates, context):
    ...
    for c in candidates:
        ...
        if (not is_abstain) and (not is_span_in_context(c, context)):
            continue
...
def is_span_in_context(answer, context):
    ans = normalize_span_text(parse_final_answer_text(answer))
...
def eval_mitigation_on_packs(
    ...
    for pack in packs:
        ...
        if policy_name == "base":
            ...
            action = f"extract_K{K}_group_sc"
