...
# ---------- Files ----------
ANSWER_CACHE_FILE = "nq_answers_cache_final_all19.csv"

OUT_JSON_FILE = "nq_paper_overall_summary_final_all19.json"
OUT_CSV_FILE = "nq_paper_overall_summary_final_all19.csv"

ERROR_CASES_FILE = "nq_paper_error_cases_final_all19.csv"
MAX_ERROR_LOGS_PER_MODE = 200

MITI_CASES_FILE = "nq_mitigation_cases_final_all19.csv"
...
def always_extract_correct(question, reference, ref_sentence, base_answer, context="", K=1):
    ...
    for lbl, cands in groups.items():
        ...
        for ai in cands:
            # ⭐ 优先：只要是 gold correct，直接返回（最强修复）
            if nq_gold_ok(ai, reference):
                return final_clean_output(ai), float(1.0)
