...
# ---------- Files ----------
ANSWER_CACHE_FILE = "nq_answers_cache_final_all23.csv"

OUT_JSON_FILE = "nq_paper_overall_summary_final_all23.json"
OUT_CSV_FILE = "nq_paper_overall_summary_final_all23.csv"

ERROR_CASES_FILE = "nq_paper_error_cases_final_all23.csv"
MAX_ERROR_LOGS_PER_MODE = 200

MITI_CASES_FILE = "nq_mitigation_cases_final_all23.csv"
...
def _filter_candidates(question, candidates, context):
    ...
    for c in candidates:
        ...
        ent, con = detector_mnli_signal(question, ans)
