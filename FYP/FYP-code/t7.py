...
# ---------- Files ----------
ANSWER_CACHE_FILE = "truthfulqa_answers_cache_all7.csv"

OUT_JSON_FILE = "truthfulqa_paper_overall_summary_all7.json"
OUT_CSV_FILE  = "truthfulqa_paper_overall_summary_all7.csv"

ERROR_CASES_FILE = "truthfulqa_paper_error_cases_all7.csv"
MAX_ERROR_LOGS_PER_MODE = 200

MITI_CASES_FILE = "truthfulqa_mitigation_cases_all7.csv"
...
- Do not guess
- Only say "I do not know" if a short truthful answer cannot be given
...
def eval_mitigation_on_packs(
    ...
    for pack in packs:
        ...
        base_ok, _ = score_single_answer_real(q, base_answer, peer_answers=pack["answers"], sc_override=pack["sc"])
