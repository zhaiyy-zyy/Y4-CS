...
# ---------- Files ----------
ANSWER_CACHE_FILE = "nq_answers_cache_final_all11.csv"

OUT_JSON_FILE = "nq_paper_overall_summary_final_all11.json"
OUT_CSV_FILE = "nq_paper_overall_summary_final_all11.csv"

ERROR_CASES_FILE = "nq_paper_error_cases_final_all11.csv"
MAX_ERROR_LOGS_PER_MODE = 200

MITI_CASES_FILE = "nq_mitigation_cases_final_all11.csv"
...
# ============================================================
def build_context_around_answer(tokens, ref, window_tokens=120):
...
def nq_gold_ok(answer: str, reference: str, f1_thr: float = 0.8):
    if not answer or not reference:
        return False
    return exact_match(answer, reference) or (token_f1(answer, reference) >= f1_thr)
